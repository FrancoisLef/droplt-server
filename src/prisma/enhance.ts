...
const inputsInfo = {
  ...
  TorrentOrderByWithRelationAndSearchRelevanceInput: ["torrentId", "name", "size", "path", "eta", "files", "progress", "ratio", "status", "downloaded", "uploaded", "createdAt", "updatedAt", "addedAt", "completedAt", "_relevance"],
  ...
  TorrentFileOrderByWithRelationAndSearchRelevanceInput: ["torrentFileId", "torrentId", "name", "size", "downloaded", "Torrent", "createdAt", "updatedAt", "_relevance"],
  ...
  TorrentCreateManyInput: ["torrentId", "name", "size", "path", "eta", "progress", "ratio", "status", "downloaded", "uploaded", "createdAt", "updatedAt", "addedAt", "completedAt"],
  ...
  TorrentOrderByRelevanceInput: ["fields", "sort", "search"],
  ...
  TorrentFileOrderByRelevanceInput: ["fields", "sort", "search"],
