...
export class FindFirstTorrentArgs {
  ...
  distinct?: Array<"torrentId" | "hash" | "transmissionId" | "name" | "size" | "path" | "progress" | "ratio" | "status" | "downloaded" | "uploaded" | "addedAt" | "completedAt" | "createdAt" | "updatedAt"> | undefined;
}
